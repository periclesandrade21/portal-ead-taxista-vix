...
agent_communication:
  ...
  - agent: "main"
    message: "🚀 STARTING MOODLE INTEGRATION - Iniciando integração prioritária do Moodle com o portal do aluno. Roteamento confirmado como funcional. Focarei na integração do Moodle dockerizado com SSO/autenticação, liberação de cursos baseada no status de pagamento, e correção paralela dos problemas de webhook metadata storage."
  - agent: "main"
